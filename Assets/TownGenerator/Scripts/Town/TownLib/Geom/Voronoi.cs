...
namespace Town.Geom
{
    public class Voronoi
    {
        ...
        private Region BuildRegion(Vector2 p)
        {
            ...
            region.Vertices.AddRange(
                Enumerable.Where(Triangles, tr => tr.P1 == p || tr.P2 == p || tr.P3 == p)
            );
        ...
        {
            return !(
                Frame.Contains(triangle.P1)
                || Frame.Contains(triangle.P2)
                || Frame.Contains(triangle.P3)
            );
        }
        ...
        public List<Region> Partitioning()
        {
            ...
            return Enumerable
                .Where<Vector2>(Points, p => Enumerable.All(regions[p].Vertices, IsReal))
                .Select(p => _regions[p])
                .ToList();
        }
    ...
    public class Triangle
    {
        ...
        {
            return (P1 == a && P2 == b) || (P2 == a && P3 == b) || (P3 == a && P1 == b);
        }
    }
