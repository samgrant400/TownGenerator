...
namespace SplineMesh
{
    ...
    public class SplineExtrusion : MonoBehaviour
    {
        ...
        private void Reset()
        {
            ...
            shapeVertices.Add(
                new ExtrusionSegment.Vertex(new Vector2(1, -0.5f), new Vector2(1, -1), 0.33f)
            );
            shapeVertices.Add(
                new ExtrusionSegment.Vertex(new Vector2(-1, -0.5f), new Vector2(-1, -1), 0.66f)
            );
            toUpdate = true;
            OnEnable();
        }
        ...
        private void GenerateMesh()
        {
            ...
            {
                GameObject go = UOUtility.Create(
                    "segment " + i++,
                    generated,
                    typeof(MeshFilter),
                    typeof(MeshRenderer),
