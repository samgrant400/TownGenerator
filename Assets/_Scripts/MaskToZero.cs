...
namespace Twobob.Mm2
{
    ...
    [GeneratorMenu(
        menu = "Map/Modifiers",
        name = "MaskToZero",
        iconName = "GeneratorIcons/MapMask",
        disengageable = true,
    ...
    public class MaskToZeroMARK1 : Generator, IMultiInlet, IOutlet<MatrixWorld>
    {
        ...
        static void EnlistInMenu() =>
            MapMagic.Nodes.GUI.CreateRightClick.generatorTypes.Add(typeof(MaskToZeroMARK1));
#endif
        ...
        public override void Generate(TileData data, StopToken stop)
        {
            ...
            MatrixWorld matrixB = new MatrixWorld(
                data.area.full.rect,
            ...
            {
                data.StoreProduct(this, matrixA);
                return;
            }
